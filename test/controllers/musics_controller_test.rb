...
class MusicsControllerTest < ActionController::TestCase
  ...
  test "should create music" do
    assert_difference('Music.count') do
      post :create, music: { Album: @music.Album, Artist: @music.Artist, description: @music.description, picture: @music.picture, ratings: @music.ratings }
    end
  ...
  test "should update music" do
    patch :update, id: @music, music: { Album: @music.Album, Artist: @music.Artist, description: @music.description, picture: @music.picture, ratings: @music.ratings }
    assert_redirected_to music_path(assigns(:music))
  end
